...
__1.2.__ При записи этих данных в БД сгенерируется id  
__1.3.__ dfgd  
...
__2.3.__ Если не существует кэша с ключом file, то информация о выбранном файле придется читать из БД MongoDb  
